...
import { FileText, Filter, Trash2, Info, AlertTriangle, XCircle, Bug, Clock, Database, Globe, Cpu } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 text-sm text-white/60">
            ...
            <span className="text-xs bg-slate-700/50 px-2 py-1 rounded">
              {settings.verboseLogging ? 'Verbose' : 'Important only'}
            </span>
          </div>
        </div>
      </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center space-x-2">
                          ...
                          {log.source && (
                            <div className="flex items-center space-x-1 text-xs text-white/60 bg-slate-700/50 px-2 py-0.5 rounded">
                      ...
                      {log.data && (
                        <details className="mt-2">
                          ...
                          <pre className="mt-2 text-xs text-white/60 bg-slate-800/50 p-2 rounded overflow-x-auto">
